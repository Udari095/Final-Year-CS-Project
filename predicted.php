        ...
        <form id="feedbackForm" method="post" action="feedback.php">
            ...
            <div class="feedback-section">
                ...
                <select name="area_text" required class="controls w-4/5 p-2 border rounded">
                    ...
                    <option value="AluthkadeEast">Aluthkade East</option>
                    <option value="AluthkadeWest">Aluthkade West</option>
                    <option value="Bambalapitiya">Bambalapitiya</option>
                    <option value="Baththaramulla">Baththaramulla</option>
                    <option value="Bloemendhal">Bloemendhal</option>
                    <option value="BorellaNorth">Borella North</option>
                    <option value="BorellaSouth">Borella South</option>
                    <option value="ColomboFort">Colombo Fort</option>
                    <option value="Dehiwala">Dehiwala</option>
                    <option value="Dematagoda">Dematagoda</option>
                    <option value="GrandpassNorth">Grandpass North</option>
                    <option value="GrandpassSouth">Grandpass South</option>
                    ...
                    <option value="KotahenaEast">Kotahena East</option>
                    <option value="KotahenaWest">Kotahena West</option>
                    <option value="Kottawa">Kottawa</option>
                    <option value="Kurunduwatta">Kurunduwatta</option>
                    <option value="Madampitiya">Madampitiya</option>
                    <option value="Maharagama">Maharagama</option>
                    <option value="Malabe">Malabe</option>
                    <option value="MaligawattaEast">Maligawatta East</option>
                    <option value="MaligawattaWest">Maligawatta West</option>
                    ...
                    <option value="MountLavinea">Mount Lavinea</option>
                    <option value="Narahenpita">Narahenpita</option>
                    <option value="Nawala">Nawala</option>
                    <option value="Nugegoda">Nugegoda</option>
                    <option value="Oruwala">Oruwala</option>
                    <option value="PamankadaEast">Pamankada East</option>
                    <option value="PamankadaWest">Pamankada West</option>
                    ...
                    <option value="UnionPlace">Union Place</option>
                    <option value="Welikada">Welikada</option>
                    <option value="WellawattaNorth">Wellawatta North</option>
                    <option value="WellawattaSouth">Wellawatta South</option>
                </select>
            </div>
...
<script>
      ...
      'Welikada': { lat: 6.9120, lng: 79.8921 }
    };
