...
(1, 'sarath123@gmail.com', 'I feel neutral about the app, it’s just okay.', 'No', 'Battaramulla','Air quality is generally good
Manageable, yet requires careful future planning.', 3, '2024-06-19 09:03:18'),
(2, 'danushka@gmail.com', 'I am satisfied, the app functions as expected.', 'No', 'Maradana','Has play areas. So good to me.', 4, '2024-06-22 16:44:20'),
(3, 'sarath123@gmail.com', 'I am very satisfied, the app meets my needs well.', 'No', 'Modara','great area', 5, '2024-06-22 16:44:44');
...
CREATE TABLE `password_resets` (
  ...
  CONSTRAINT `fk_password_resets_user_email` FOREIGN KEY (`email`) REFERENCES `users`(`email`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
(11, '12750841387ea7dac823ed9040bff1f789af75f33ee4766ab97344f44bbb38bf7f2574523b2695a2dbf3c8697ecbb2c6245d', 'sarath123@gmail.com', 1718430459);
...
CREATE TABLE `saved_locations` (
  ...
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT `fk_saved_locations_user_email` FOREIGN KEY (`email`) REFERENCES `users`(`email`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
...
(1, 'sarath123@gmail.com', 'Dematagoda', '6.9364,79.8786'),
(2, 'danushka@gmail.com', 'Wellawatta_North', '6.8721,79.8613');
